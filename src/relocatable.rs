...
pub fn link<E: Arch>(ctx: &mut Context<E>) {
    ...
    // Records synthesized from DWARF FDEs are regenerated by the next
    // link from the __eh_frame emitted below, and are skipped; a
    ...
    // UNSIGNED relocations exactly as compilers emit them.
